 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:8080/WebServer/WebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WebServer/WebService?wsdl");
